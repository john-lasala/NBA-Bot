    ...
    <body>
        <div class="box">
            ...
            <p>
                ...
                It currently supports 3 main commands: PastChampions, CurrentStandings, and LeagueLeaders (explained below).
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <th>$help</th>
                        <td>Shows the user all of the current commands and how to use them</td>
                    </tr>
                    <tr>
                        <th>$pastChampions</th>
